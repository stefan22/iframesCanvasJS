...
*  ¡∞•••••••
      ...
      <canvas id="Canvas1" width="400" height="300">Your browser does not support canvas.
      </canvas>
*/
...
/*
<pre>    
    <p id="tourselector">Choose a tour: 
    <select>
        <option value="BigSur">Big Sur Retreat</option>
        
        <option value="DeathVal">The Death Valley Survivors Trek</option>
